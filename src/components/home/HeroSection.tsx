  ...
  return (
    ...
    >
      <Image
        ...
        alt="Salle elegante du restaurant Wok In a Rebecq"
        fill
        priority
      ...
      <div className="relative z-10 px-4 max-w-4xl mx-auto">
        <motion.p {...fadeUp(0.2)} className="eyebrow mb-5">
        ...
        >
          L&apos;Asie
          <br />
          <span className="text-gold">a votre table</span>
        </motion.h1>
        ...
        >
          Buffet a volonte &nbsp;·&nbsp; Wok &nbsp;·&nbsp; Teppanyaki
        </motion.p>
        ...
        >
          ...
          <a
            ...
            aria-label="Voir l'itineraire vers Wok In sur Google Maps"
          >
